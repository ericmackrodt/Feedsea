...
namespace feedsea.AudioPlaybackAgent
{
      ...
      : AudioPlayerAgent
   {
      ...
      //AudioTrack audioTrack = new AudioTrack(new Uri("http://jovemnerd.com.br/podpress_trac/feed/94648/0/MRG214G_South_Park.mp3", UriKind.Absolute), "Lullabies", "Bob Acri", "Bob Acri", null);
      /// <remarks>
      ...
      public AudioPlayer()
      {
         if ( !_classInitialized )
         {
            ...
            Windows.ApplicationModel.Core.CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, delegate
               {
                  Windows.UI.Xaml.Application.Current.UnhandledException += AudioPlayer_UnhandledException;
               });
         }
      }
