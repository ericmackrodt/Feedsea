...
namespace feedsea.Common.Controls
{
   ...
   public class NavigateOnTapTrigger
      : Behavior<Windows.UI.Xaml.FrameworkElement>
   {
      ...
      public static readonly Windows.UI.Xaml.DependencyProperty NavigationObjectProperty = Windows.UI.Xaml.DependencyProperty.Register("NavigationObject", typeof(string), typeof(NavigateOnTapTrigger), new PropertyMetadata(null, new PropertyChangedCallback(NavigationObjectPropertyChanged)));
      ...
      // Using a DependencyProperty as the backing store for Command.  This enables animation, styling, binding, etc...
      public static readonly Windows.UI.Xaml.DependencyProperty NavigationParameterProperty = Windows.UI.Xaml.DependencyProperty.Register("NavigationParameter", typeof(string), typeof(NavigateOnTapTrigger), new PropertyMetadata(null));
      ...
      public static readonly Windows.UI.Xaml.DependencyProperty NavigationSecondParameterProperty = Windows.UI.Xaml.DependencyProperty.Register("NavigationSecondParameter", typeof(string), typeof(NavigateOnTapTrigger), new PropertyMetadata(null));

      protected override void OnAttached()
      {
         base.OnAttached();
         AssociatedObject.Tapped += AssociatedObject_Tap;
      }

      void AssociatedObject_Tap(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
      {
