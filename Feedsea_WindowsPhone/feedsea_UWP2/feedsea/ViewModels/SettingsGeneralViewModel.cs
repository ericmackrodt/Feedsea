...
namespace feedsea.ViewModels
{
   ...
   public class SettingsGeneralViewModel
      : AViewModel<SettingsGeneralViewModel>
   {
...
#region Settings_Properties
      ...
      public bool ShowArticlesFromOldestToNewest
      {
         get
         {
            return _settings.ArticlesFromOldestToNewestSetting;
         }
         set
         {
      ...
      public bool MarkArticlesReadWhenOpened
      {
         get
         {
            return _settings.MarkArticlesReadWhenOpenedSetting;
         }
         set
         {
      ...
      public bool ShowReadArticles
      {
         get
         {
            return _settings.ShowReadSetting;
         }
         set
         {
      ...
      public bool DownloadArticleIfNoContent
      {
         get
         {
            return _settings.DownloadArticleIfNoContentSetting;
         }
         set
         {
      ...
      public INewsSource SelectedSource
      {
         get
         {
            return Sources.FirstOrDefault(o => o.UrlID == _settings.CategoryToLoadSetting);
         }
         set
         {
            var src = value;
      ...
      public bool MarkReadOnFeedScroll
      {
         get
         {
            return _settings.MarkReadOnFeedScrollSetting;
         }
         set
         {
      ...
      public bool ShowReadIfNoUnread
      {
         get
         {
            return _settings.ShowReadIfNoUnreadSetting;
         }
         set
         {
      ...
      public bool AskBeforeMarkingAllRead
      {
         get
         {
            return _settings.AskConfirmationMarkReadSetting;
         }
         set
         {
      ...
      public async Task LoadDataAsync()
      {
         ...
         Sources.Add(new SubscriptionData()
            {
               UrlID = null, Name = AppResources.AllArticles
            });
