...
namespace feedsea.ViewModels
{
   ...
   public class ShareArticleViewModel
      : AViewModel<ShareArticleViewModel>
   {
      ...
      public ShareArticleViewModel(IShareProxy shareProxy, IOneNoteProvider oneNoteProvider, IOneNoteSettings oneNoteSettings, IGeneralSettings generalSettings, IThirdPartySettings thirdPartySettings, IConnectionVerify connectionVerify, IPocketSettings pocketSettings, IPocketProvider pocketProvider, IInstapaperSettings instapaperSettings, IInstapaperProvider instapaperProvider, ILoadingService loadingService, IMobilizerProvider mobilizerProvider, IArticleHtmlBuilder htmlBuilder)
      {
         _share = shareProxy;
      ...
      private void BuildShareButtons()
      {
         ...
         Buttons.Add(new ShareButtonModel()
            {
               Title = AppResources.Share_SocialNetworks, Image = "../Assets/Icons/share.social.png", ShareCommand = new RelayCommand(SocialNetworkShare)
            });
         Buttons.Add(new ShareButtonModel()
            {
               Title = AppResources.Share_Email, Image = "../Assets/Icons/share.email.png", ShareCommand = new RelayCommand(EmailShare)
            });
         Buttons.Add(new ShareButtonModel()
            {
               Title = AppResources.Share_TextMessage, Image = "../Assets/Icons/share.sms.png", ShareCommand = new RelayCommand(TextMessageShare)
            });
         Buttons.Add(new ShareButtonModel()
            {
               Title = AppResources.Share_Clipboard, Image = "../Assets/Icons/share.clipboard.png", ShareCommand = new RelayCommand(ClipboardShare)
            });
         //if (false)
         //    Buttons.Add(new ShareButtonModel()
         //    {
         ...
         if ( _oneNoteSettings.IsLoggedInSetting )
            Buttons.Add(new ShareButtonModel()
               {
                  Title = AppResources.Share_OneNote, Image = "../Assets/Icons/share.onenote.png", ShareCommand = new AsyncDelegateCommand(OneNoteShare)
               });
         if ( _thirdPartySettings.IsPocketEnabledSetting )
         {
            var model = new ShareButtonModel()
               {
                  Title = AppResources.Share_Pocket, Image = "../Assets/Icons/share.pocket.png"
               };
         ...
         if ( _instapaperSettings.IsEnabledSetting )
            Buttons.Add(new ShareButtonModel()
               {
                  Title = AppResources.Share_Instapaper, Image = "../Assets/Icons/share.instapaper.png", ShareCommand = new AsyncDelegateCommand(InstapaperShare)
               });
      }
