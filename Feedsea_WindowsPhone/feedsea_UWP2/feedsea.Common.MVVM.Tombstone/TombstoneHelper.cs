...
namespace feedsea.Common.MVVM.Tombstone
{
   ...
   public sealed class TombstoneHelper
   {
      ...
      public static void page_OnNavigatedTo(Windows.UI.Xaml.Controls.Page sender, Windows.UI.Xaml.Navigation.NavigationEventArgs e)
      {
      ...
      public static void page_OnNavigatedFrom(Windows.UI.Xaml.Controls.Page sender, Windows.UI.Xaml.Navigation.NavigationEventArgs e)
      {
