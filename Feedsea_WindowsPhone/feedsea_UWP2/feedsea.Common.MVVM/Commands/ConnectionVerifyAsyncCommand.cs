...
namespace feedsea.Common.MVVM.Commands
{
   ...
   public class ConnectionVerifyAsyncCommand
      : ConnectionVerifyAsyncCommand<object>
   {
      ...
      public ConnectionVerifyAsyncCommand(Func<object, Task> asyncExecute, Predicate<object> canExecute, IConnectionVerify connectionVerify)
      : base(asyncExecute, canExecute, connectionVerify)
      {
      }
   }

   public class ConnectionVerifyAsyncCommand<T>
      : ICommand
   {
      ...
      public ConnectionVerifyAsyncCommand(Func<T, Task> asyncExecute, Predicate<object> canExecute, IConnectionVerify connectionVerify)
      {
