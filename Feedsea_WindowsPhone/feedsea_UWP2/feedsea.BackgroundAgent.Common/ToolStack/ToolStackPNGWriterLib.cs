   ...
   public static class PNGWriter
   {
      ...
      */
      ...
      public static void DetectWBByteOrder()
      {
         ...
         var redRectangle = new Windows.UI.Xaml.Shapes.Rectangle();
         redRectangle.Width = 1;
         redRectangle.Height = 1;
         redRectangle.Fill = new Windows.UI.Xaml.Media.SolidColorBrush(Windows.UI.Colors.Red);
         // Create the green 1 pixel rectangle.
         var greenRectangle = new Windows.UI.Xaml.Shapes.Rectangle();
         greenRectangle.Width = 1;
         greenRectangle.Height = 1;
         greenRectangle.Fill = new Windows.UI.Xaml.Media.SolidColorBrush(Windows.UI.Colors.Green);
         // Create the blue 1 pixel rectangle.
         var blueRectangle = new Windows.UI.Xaml.Shapes.Rectangle();
         blueRectangle.Width = 1;
         blueRectangle.Height = 1;
         blueRectangle.Fill = new Windows.UI.Xaml.Media.SolidColorBrush(Windows.UI.Colors.Blue);
         // Render the three 1 px rectangles.
         TestWB.Render(redRectangle, new Windows.UI.Xaml.Media.TranslateTransform()
            {
               X = 0, Y = 0
            });
         TestWB.Render(greenRectangle, new Windows.UI.Xaml.Media.TranslateTransform()
            {
               X = 1, Y = 0
            });
         TestWB.Render(blueRectangle, new Windows.UI.Xaml.Media.TranslateTransform()
            {
               X = 2, Y = 0
            });
         ...
         if ( redBytes[0] == greenBytes[0] && blueBytes[0] == greenBytes[0] )
         {
            trans = 0;
         }
         if ( redBytes[1] == greenBytes[1] && blueBytes[1] == greenBytes[1] )
         {
            trans = 1;
         }
         if ( redBytes[2] == greenBytes[2] && blueBytes[2] == greenBytes[2] )
         {
            trans = 2;
         }
         if ( redBytes[3] == greenBytes[3] && blueBytes[3] == greenBytes[3] )
         {
            trans = 3;
         }
         ...
         if ( trans != 4 )
         {
            ...
            else if ( redBytes[1] == 255 )
            {
               red = 1;
            }
            else if ( redBytes[2] == 255 )
            {
               red = 2;
            }
            else if ( redBytes[3] == 255 )
            {
               red = 3;
            }
            ...
            else if ( greenBytes[1] == 128 )
            {
               green = 1;
            }
            else if ( greenBytes[2] == 128 )
            {
               green = 2;
            }
            else if ( greenBytes[3] == 128 )
            {
               green = 3;
            }
            ...
            else if ( blueBytes[1] == 255 )
            {
               blue = 1;
            }
            else if ( blueBytes[2] == 255 )
            {
               blue = 2;
            }
            else if ( blueBytes[3] == 255 )
            {
               blue = 3;
            }
         }
