...
namespace feedsea.Common.Providers.Feedly
{
    ...
    {
        public static CategoryData ToCategory(this FeedCategory cat)
        {
        ...
        public static IEnumerable<ArticleData> ToArticleCollection(this IEnumerable<Entry> entries, Func<string, SubscriptionData> getSource = null)
        {
            ...
            foreach (var item in entries)
            {
                ...
                if (getSource != null)
                    article.Source = getSource(item.Origin.StreamId) ?? article.Source;
                col.Add(article);
            }
            return col;
        }
