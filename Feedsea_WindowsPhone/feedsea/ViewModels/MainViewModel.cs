...
{
    public class MainViewModel : AViewModel<MainViewModel>
    {
        #region Events
        ...
        {
            get { return _newsService.SelectedSource; }
            set { _newsService.SelectedSource = value; }
        }
        ...
        {
            get { return !_generalSettings.IsAdsDisabledSetting; }
            set
            {
        ...
        {
            get { return _appearanceSettings.ArticleItemsTemplateTypeSetting; }
            set
            {
        ...
        {
            get { return addToFavoritesCommand; }
        }
        ...
        private async Task PinToStart(INewsSource obj)
        {
            ...
            {
                NavigationUri = new Uri("/Views/MainPage.xaml?open=" + HttpUtility.UrlEncode(obj.UrlID), UriKind.Relative),
            ...
            tileData.Front = new TileFace()
            {
                ...
                Image = firstArticle.MainImageUrl,
                Favicon = firstArticle.Source.Link
            };

            tileData.Back = new TileFace()
            {
                SourceID = obj.UrlID,
                SourceName = secondArticle.Source.Name,
                Title = secondArticle.Title,
                Image = secondArticle.MainImageUrl,
                Favicon = secondArticle.Source.Link
            };
