...
{
    public class SettingsAppearanceViewModel : AViewModel<SettingsAppearanceViewModel>
    {
        ...
        {
            get { return _settings.HideAppBarOnMainPageSetting; }
            set
            {
        ...
        {
            get { return _settings.HideAppBarOnArticlePageSetting; }
            set
            {
        ...
        {
            get { return _settings.ShowTrayOnTopSetting; }
            set
            {
        ...
        {
            get { return (int)_settings.CurrentThemeSetting; }
            set
            {
        ...
        {
            get { return (int)_settings.ArticleItemsTemplateTypeSetting; }
            set
            {
