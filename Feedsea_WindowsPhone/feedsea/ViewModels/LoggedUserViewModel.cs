...
{
    public class LoggedUserViewModel : AViewModel<LoggedUserViewModel>
    {
        ...
        public LoggedUserViewModel(IGeneralSettings settings)
        {
            ...
            {
                Name = _settings.UserNameSetting ?? AppResources.Sources,
                Picture = _settings.ProfilePictureSetting,
                Service = _settings.LoggedInServiceSetting,
                ServiceUser = _settings.LoginEmailSetting
            };
