...
{
    [DataContract]
    public class ApplicationFrameViewModel : AViewModel<ApplicationFrameViewModel>
    {
        ...
        {
            get { return _appearanceSettings.ShowTrayOnTopSetting; }
            set
            {
                showAppTray = value;
        ...
        {
            get { return _appearanceSettings.HideAppBarOnMainPageSetting; }
            set
            {
        ...
        {
            get { return _appearanceSettings.HideAppBarOnArticlePageSetting; }
            set
            {
