...
{
    [DataContract]
    public class ArticleViewModel : AViewModel<ArticleViewModel>
    {
        ...
        public ArticleViewModel()
        {
            ...
            playArticleAudioCommand = new RelayCommand(PlayArticleAudio) { IsEnabled = true };
