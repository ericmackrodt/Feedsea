...
{
    [DataContract]
    public class SelectedSourceViewModel : AViewModel<SelectedSourceViewModel>
    {
        private INewsService newsService;

        public INewsSource SelectedSource
        {
            get { return newsService.SelectedSource; }
            set { newsService.SelectedSource = value; }
        }

        private ICommand clearSelectedSourceCommand;
        public ICommand ClearSelectedSourceCommand
        {
            get { return clearSelectedSourceCommand; }
            set { clearSelectedSourceCommand = value; }
        }
