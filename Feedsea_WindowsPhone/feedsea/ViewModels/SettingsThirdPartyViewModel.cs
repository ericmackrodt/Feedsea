...
{
    public class SettingsThirdPartyViewModel : AViewModel<SettingsThirdPartyViewModel>
    {
        ...
        {
            get { return (int)_settings.YoutubeClientSetting; }
            set
            {
        ...
        {
            get { return (int)_settings.LinkNavigationSetting; }
            set
            {
        ...
        {
            get { return _settings.IsPocketEnabledSetting; }
            set
            {
        ...
        {
            get { return _settings.PocketShareEnabledSetting; }
            set
            {
        ...
        {
            get { return _pocketSettings.IsEnabledSetting; }
            set
            {
        ...
        {
            get { return _instapaperSettings.IsEnabledSetting; }
            set
            {
        ...
        {
            get { return _oneNoteSettings.IsLoggedInSetting; }
            set
            {
        ...
        {
            get { return _toggleOneNoteCommand; }
            set { _toggleOneNoteCommand = value; }
        }

        private ICommand _togglePocketCommand;
        public ICommand TogglePocketCommand
        {
            get { return _togglePocketCommand; }
        }

        private ICommand _toggleInstapaperCommand;
        public ICommand ToggleInstapaperCommand
        {
            get { return _toggleInstapaperCommand; }
        }

        #endregion Commands

        public SettingsThirdPartyViewModel(
            IThirdPartySettings settings,
            IOneNoteProvider oneNoteProvider, 
            IOneNoteSettings oneNoteSettings,
            IOAuthLogin oauthLogin,
            IXAuthLogin xauthLogin,
        ...
        private async Task TogglePocket(object arg)
        {
            ...
            if (choice == 0)
            {
                IsPocketEnabled = IsInternalPocketEnabled = await ConnectionVerifyCall(async () =>
                {
                    ...
                    if (preLoginResult == null) return false;
