...
{
    public class ArticleDesignViewModel : ArticleViewModel
    {
        public ArticleDesignViewModel()
            : base(null, null, null, null, null, null)
        {
//            Article = new Article()
//            {
//                Title = "Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis.",
