    ...
    public static class TileHelper
    {
        ...
        public static void SaveJpeg(this ITileContentBuilder tile, TileSize tileSize, TileType type, string shellContentFolder, string fileNameSufix, string fileName, IsolatedStorageFile storage)
        {
            ...
            try
            {
                ...
                control.Measure(new Size(width, 336));
                control.UpdateLayout();
                control.Arrange(new Rect(0, 0, width, 336));
                ...
                wb.Render(control, new System.Windows.Media.TranslateTransform());
                wb.Invalidate();

                using (IsolatedStorageFileStream myFileStream = storage.CreateFile(fileName))
                {
        ...
        public static void SetSource(this BitmapImage image, byte[] buffer)
        {
